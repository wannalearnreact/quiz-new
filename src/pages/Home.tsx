...
const Home = () => {
    ...
    const { isLoading, error, allQuizzes } = useGetQuizzes(); // Retrieve the allQuizzes state from the useGetQuizzes hook
    ...
    return (
        <div className='max-w-screen-lg  w-2/3 my-0 mx-auto text-center mt-10'>
            ...
            {error ? (
                ...
                <Quizzes quizzes={allQuizzes} setQuizzes={setQuizzes} /> // Pass the allQuizzes state to the Quizzes component
            )}
        </div>
    );
};
